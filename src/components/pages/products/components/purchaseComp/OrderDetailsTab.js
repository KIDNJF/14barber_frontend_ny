...
const OrderDetailsTab = ({ RowData, isTablet }) => {
  return (
                ...
                <div className="custom-card">
                  ...
                  <div className="card-body">
                    <div className="list-group-flush">
                      {/* <div className="list-group-item bg-transparent d-flex justify-content-between px-0 py-1 font-weight-semi-bold border-top-0 border border-red-600">
                        <p className="mb-0 ml-4">
                          <strong>Processed by</strong>
                        </p>
                        <p className="mb-0 mr-4">Airi Satou</p>
                      </div> */}
                      <div className="list-group-item bg-transparent d-flex justify-content-between px-0 py-1 border border-red-600">
                        <p className="mb-0 ml-4">
