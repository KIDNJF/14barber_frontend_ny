              ...
              <>
                ...
                <div
                  className={
                    open
                      ? "hidden"
                      : `w-36 rounded-lg z-10 ${
                          isTablet ? "mt-36" : "mt-40"
                        } shadow border absolute bg-white justify-end right-0`
                  }
                  onClick={handleDropDown}
                >
                  <ul className="space-y-3 p-0.5">
                    {Data.map((item, index) => (
                      <li key={index} className="font-medium">
                        <div>
                          <button
                            className="flex cursor-pointer text-gray-800 items-center pl-2.5 transform transition-colors duration-200 border-transparent"
